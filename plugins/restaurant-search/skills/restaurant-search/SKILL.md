...
description: Find restaurants in a given city or area that are actually open at a given time and that verifiably serve meat-free dishes or kosher fin fish — vegetarian mains, pasta/pizza without meat, fin fish (never shellfish), or fries — by searching the web and reading real menus. Use this skill whenever the user asks where to eat, for restaurant or dinner/lunch recommendations, for "places open now" near a location, for somewhere to eat with a group, or mentions wanting food options in a city or neighborhood — even if they don't spell out the opening-hours or menu requirements, and even if they only name a place and say they're hungry.
---
